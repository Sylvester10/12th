...
class Locations_model_ajax extends CI_Model {
	...
	var $table = 'locations';
	var $column_order = array(null, 'id', 'name', 'about'); //set column field database for datatable orderable
	var $column_search = array('id', 'name', 'about'); //set column field database for datatable searchable 
	...
	public function actions($id) {
		...
		return '<p><a type="button" href="' . base_url('locations/edit_location/'.$id) .'" class="btn btn-default btn-sm btn-block action-btn clickable"> <i class="fa fa-pencil" style="color: blue"></i> &nbsp; Edit </a></p>
	...
	public function modals($id) {
		$y = $this->common_model->get_locations_details_by_id($id);
		$modal_delete_confirm = modal_delete_confirm($id, $y->title, 'locations', 'locations/delete_locations');
