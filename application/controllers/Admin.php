...
Model: Admin_model, Property_model, Staff_model, Newsletter_model, Locatons_model, Testimonial_model
...
class Admin extends MY_Controller
{
	...
	public function index() { //admin dashboard, routed as dashboard
		...
		$data['total_properties'] = $this->property_model->count_property();
		$data['total_newsletter'] = $this->newsletter_model->count_newsletter_subscribers();
		$data['total_locations'] = $this->locations_model->count_locations();
