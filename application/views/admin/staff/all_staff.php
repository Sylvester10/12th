...
<?php echo custom_validation_errors(); ?>
	...
	<div class="new-item">
		<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('staff/new_staff'); ?>"><i class="fa fa-plus"></i> New Staff</a>
	</div>
	...
	echo modal_bulk_actions('staff/bulk_actions_staff', $options_array); ?>
