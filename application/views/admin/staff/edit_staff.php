...
<?php echo flash_message_danger('status_msg_error'); ?>
	...
	<div class="new-item">
		<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('staff/staff_profile/'.$y->id); ?>"><i class="fa fa-user"></i> View Staff</a>
		<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('staff'); ?>"><i class="fa fa-users"></i> All Staff</a>
	</div>

	<?php 
	echo form_open_multipart('staff/edit_staff_action/'.$y->id); ?>
			...
			<div class="col-md-6 col-sm-12 col-xs-12">
				...
				<div class="form-group">
					...
					<label class="form-control-label">Staff Photo
						<small>(Optional. Only jpg and png files allowed. Max 5MB)</small>
					</label>
